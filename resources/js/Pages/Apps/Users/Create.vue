                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.nik" :class="{ 'is-invalid': errors.nik }" type="text" placeholder="Nomor Induk Kependudukan">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.phone" :class="{ 'is-invalid': errors.phone }" type="text" placeholder="No. Handphone">
                                            </div>
                                            <div v-if="errors.email" class="alert alert-danger">
                                                {{ errors.email }}
                                            </div>
