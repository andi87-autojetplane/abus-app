                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.nik" :class="{ 'is-invalid': errors.nik }" type="text" disabled>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.username" :class="{ 'is-invalid': errors.username }" type="text" disabled>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.phone" :class="{ 'is-invalid': errors.phone }" type="email" placeholder="Nomor Handphone">
                                            </div>
